...
var (
	...
	bitbucketAvatarURL = "https://bitbucket.org/account/%v/avatar/128/"
)
...
// Used to parse user email information
type emails struct {
...
// Used to parse one user's email
type email struct {
	Email       string `json:"email,omitempty"`
...
// Retrieve the primary email address of the user
...
// Retrieves bitbucket user emails from the Bitbucket API emails service
