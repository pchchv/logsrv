...
// Model for the bitbucket test suite
type BitbucketTestSuite struct {
	suite.Suite
	Server *httptest.Server
}

// Method that will be run before any method of this suite. It setups a mock server for bitbucket API
...
// Tests Bitbucket provider returns the expected information
...
// Tests the returned primary email is the expected email
...
// Runs the entire suite for Bitbucket
